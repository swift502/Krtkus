...
#define SC_RGHT MT(MOD_RSFT, KC_ENT)
#define SC_LEFT MT(MOD_LSFT, KC_ENT)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_default(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, SC_RGHT,
    ...
    [1] = LAYOUT_default(
        ...
        SC_LEFT, _______, _______, _______, _______, KC_P1,   KC_P2,   KC_P3,   _______, _______, _______, _______,
