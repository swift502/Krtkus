...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    *  ┌───┐                                       ┌───┐
    ...
    [1] = LAYOUT_default(
      ...
      _______, _______, KC_UP,   _______, KC_PGUP, KC_KP_7, KC_KP_8, KC_KP_9, _______, _______, KC_LBRC, KC_RBRC,
      KC_CAPS, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, KC_KP_4, KC_KP_5, KC_KP_6, _______, _______, _______, KC_BSLS,
      _______, _______, _______, _______, _______, KC_KP_1, KC_KP_2, KC_KP_3, _______, _______, _______, KC_ENT,
      _______, _______, _______, _______, _______,      KC_KP_0,     KC_PDOT, KC_HOME, _______, _______, KC_END
    ),
    [2] = LAYOUT_default(
      _______,                                                                                           MO(3),
    ...
    [3] = LAYOUT_default(
      ...
      _______, _______, _______, _______, EE_CLR,  _______, _______, _______, _______, _______, _______, _______,
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
